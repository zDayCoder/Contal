                    ...
                    <div class="card card-profile">
                        ...
                        <div class="card-body card-body-p">
                            ...
                            <div id="photoOptions" class="mt-3" style="display: none;">
                                <center>
                                <img class="input-profile" style="border-radius:10%;width: 125px" src="./assets/usuario1.jpg" name="photoOption" value="./assets/usuario1.jpg" onclick="showImage(this)">
                                ...
                                <img class="input-profile" style="border-radius:10%;width: 125px" src="./assets/usuario3.jpg" name="photoOption" value="./assets/usuario3.jpg" onclick="showImage(this)">
                                <img class="input-profile" style="border-radius:10%;width: 125px" src="./assets/usuario4.jpg" name="photoOption" value="./assets/usuario4.jpg" onclick="showImage(this)">
                                </center>
                            </div>
